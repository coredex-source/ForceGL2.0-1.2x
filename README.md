...
- Adds the ability to completely bypass modern rendering features for legacy GPUs.
...
- For extremely old GPUs (pre-2005 era), the new compatibility mode completely bypasses modern rendering features.
...
- For extreme cases (Intel GMA graphics, etc) enable the "Force Compatibility Mode" option to maximize compatibility with legacy hardware.
